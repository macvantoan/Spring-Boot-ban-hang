...
import com.toan.spring.validator.ProductFormValidator;
...
public class AdminController {
	...
	@InitBinder
	public void myIniBinder(WebDataBinder dataBinder) {
	...
	public String orderView(Model model, @RequestParam("orderId") String orderId) {
		...
		List<OrderDetaillnfo> details = this.orderDAO.listOrderDetaillnfos(orderId);
